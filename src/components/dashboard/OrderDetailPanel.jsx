...
const timelineIcons = {
  ...
  whatsapp_pending: { icon: Clock, color: "bg-sky-100 text-sky-600" },
  whatsapp_sent_success: { icon: CheckCircle2, color: "bg-emerald-100 text-emerald-600" },
  whatsapp_sent_failed: { icon: XCircle, color: "bg-red-100 text-red-600" },
